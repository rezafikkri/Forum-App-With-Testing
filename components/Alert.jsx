...
export default function Alert({ message, onClose, type = 'danger' }) {
  ...
  return (
    <div className={`flex items-center p-4 mb-4 ${alertClasses}`} role="alert"> 
      <div>{newMessage}</div>
      <button type="button" className="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700" onClick={onClose}>
