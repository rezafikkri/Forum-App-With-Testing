 ...
 *
 *   - should return the current state when given by DOWN_VOTE_DETAIL_THREAD action and payload userId is
 *   exists in downVotesBy thread
 ...
 *  - should return the current state when given by NEUTRAL_VOTE_DETAIL_THREAD action, payload target
 *  is equal to 'up-vote' and payload userId is not exists in upVotesBy thread
 ...
 *  - should return the current state when given by NEUTRAL_VOTE_DETAIL_THREAD action, payload target is equal
 *  to 'down-vote' and payload userId is not exists in downVotesBy thread
 ...
 *
 *  - should return the current state when given by UP_VOTE_COMMENT action and payload commentId is not
 *  exists in comments
 *  - should return the current state when given by UP_VOTE_COMMENT action, payload commentId is exists
 *  in comments and payload userId is exists in upVotesBy comment
 *  - should return the detail thread with new userId in upVotesBy comment when given by UP_VOTE_COMMENT
 *  action, payload commentId is exists in comments and payload userId is not exists in upVotesBy comment
 *
 *  - should return the current state when given by DOWN_VOTE_COMMENT action and payload commentId is not
 *  exists in comments
 *  - should return the current state when given by DOWN_VOTE_COMMENT action, payload commentId is exists
 *  in comments and payload userId is exists in downVotesBy comment
 *  - should return the detail thread with new userId in downVotesBy comment when given by DOWN_VOTE_COMMENT
 *  action, payload commentId is exists in comments and payload userId is not exists in downVotesBy comment
 *
 *
 *  - should return the current state when given by NEUTRAL_VOTE_COMMENT action and payload commentId is not
 *  exists in comments
 *  - should return the current state when given by NEUTRAL_VOTE_COMMENT action, payload commentId is exists
 *  in comments and payload target is not equal to 'up-vote' and 'down-vote'
 *
 *  - should return the current state when given by NEUTRAL_VOTE_COMMENT action, payload commentId is exists
 *  in comments, payload target is equal to 'up-vote' and payload userId is not exists in upVotesBy comment
 ...
 *
 *  - should return the current state when given by NEUTRAL_VOTE_COMMENT action, payload commentId is exists
 *  in comments, payload target is equal to 'down-vote' and payload userId is not exists in downVotesBy comment
...
describe('detailThreadReducer function', () => {
  ...
  test('should return the threads when given by RECEIVE_DETAIL_THREAD action', () => {
    // Arrange
    const currentState = null;
    const action = {
